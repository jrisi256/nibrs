# How to find all police agencies
...
* [Early report from BJS detailing how they created the crosswalk file](https://bjs.ojp.gov/content/pub/pdf/lucrdod.pdf)
...
* [Issues with the UCR's population count which is what the crosswalk file was created for](https://ucrbook.com/ucrGeneral.html#agency-population-value).
* [Problems with using the UCR data the county level](https://ucrbook.com/county-level-ucr-data.html).
